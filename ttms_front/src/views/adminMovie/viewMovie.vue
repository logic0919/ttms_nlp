      ...
      <div v-else class="detail">
        ...
        <el-descriptions title="影片详情" :column="1" border class="desc">
          ...
          <el-descriptions-item label="中文名称">{{
            movieData.chinese_name
          }}</el-descriptions-item>
          <el-descriptions-item label="英文名称">{{
            movieData.english_name
          }}</el-descriptions-item>
          <el-descriptions-item label="上映地区">{{
            movieData.area
          }}</el-descriptions-item>
          ...
          <el-descriptions-item label="影片时长"
            >{{ movieData.duration }} 分钟</el-descriptions-item
          >
          <el-descriptions-item label="类型标签">{{
            getCategoryNames(movieData.category_ids)
          }}</el-descriptions-item>
          ...
          <el-descriptions-item label="剧情简介">{{
